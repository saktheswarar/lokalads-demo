  ...
  return (
    <div className='rounded-xl shadow-md relative'>
      ...
      <div className='p-4'>
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center mb-4">
          {/* You can re-enable this block if needed */}
          {/* <div className='flex items-center gap-2 mb-4 lg:mb-0'>
            <FaMapMarker className='text-orange-700' />
            <span className='text-orange-700'>
              {property.location?.address || 'No location provided'}
            </span>
          </div> */}

          <Link
            href={`/properties/${property._id}`}
            className="h-[36px] bg-blue-500 hover:bg-blue-600 flex items-center justify-center text-white px-4 py-2 rounded-lg text-sm"
          >
            Details
          </Link>
        </div>
